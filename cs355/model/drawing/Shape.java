...
public abstract class Shape {
	...
	protected Point2D.Double transformPoint(Point2D.Double worldPoint) {
		Point2D.Double objPoint = new Point2D.Double();
		Point2D.Double c = center;
		AffineTransform worldToObj = new AffineTransform();
		worldToObj.rotate(-rotation);
		worldToObj.translate(-c.x, -c.y);
		worldToObj.transform(worldPoint, objPoint);
		return objPoint;
	}
}
