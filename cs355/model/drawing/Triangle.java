...
public class Triangle extends Shape {
	...
	public boolean pointInShape(Point2D.Double pt, double tolerance) {
		Point2D.Double objPt = transformPoint(pt);
		double p1 = PointOps.dot(PointOps.subtract(objPt, a), PointOps.normal(PointOps.subtract(b, a)));
		double p2 = PointOps.dot(PointOps.subtract(objPt, b), PointOps.normal(PointOps.subtract(c, b)));
		double p3 = PointOps.dot(PointOps.subtract(objPt, c), PointOps.normal(PointOps.subtract(a, c)));
